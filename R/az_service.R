...
#' Generally, the easiest way to initialize a new recommendations service object is via the `create_rec_service` or `get_rec_service` methods of the [AzureRMR::az_subscription] or [AzureRMR::az_resource_group] classes.
#'
